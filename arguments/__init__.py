...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.percent_dense = 0.01 #change Original parameters
        # self.percent_dense = 0.0005 #change
        self.lambda_dssim = 0.2
        self.lambda_dist = 0. #change Original parameters
        # self.lambda_dist = 10. #change
        ...
        self.contribution_prune_interval = 300 #change Original parameters
        self.contribution_prune_ratio = 0.1 # change Original parameters
        # self.contribution_prune_interval = 1800 #change
        # self.contribution_prune_ratio = 0.5 #change
